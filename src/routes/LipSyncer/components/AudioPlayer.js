  ...
  render () {
    ...
    return (
      <div>
        ...
        <input type="number" step="0.25" min="0.5" max="4" value={data.playbackRate} onChange={this.changed.bind(this)} style={{width: '50px', display: 'inline-block', verticalAlign: 'top'}} />
      </div>
    )
  }
